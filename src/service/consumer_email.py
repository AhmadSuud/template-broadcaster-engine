...
class ConsumerEmail:
    ...
    def _connect_smtp(self, account_config):
    ...
    def _get_smtp(self, account_config):
        config_key = (account_config.get("host"), account_config.get("port"), account_config.get("username"))
        if self._smtp is None or self._smtp_config_key != config_key:
            self._smtp = self._connect_smtp(account_config)
            self._smtp_config_key = config_key
        return self._smtp
    ...
    def send_email(self, receiver, subject, body):
        ...
        from_addr = account_config.get("fromAddress", account_config.get("username"))
        ...
        try:
            smtp = self._get_smtp(account_config)
